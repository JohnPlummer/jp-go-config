...
Progressive loading documentation system for jp-go-config package.
...
- Specific to jp-go-config package only
...
- Usage guide: `common/standards/go/jp-go-config.md` (how to USE this package)
